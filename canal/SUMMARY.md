...
* [Canales y Automatización](README.md)

## Configuración en Meta

* [Cómo agregar un método de pago y configurar el perfil de tu número de WhatsApp API](configuracion-en-meta/como-agregar-un-metodo-de-pago-y-configurar-el-perfil-de-tu-numero-de-whatsapp-api.md)
* [Cómo verificar tu negocio (Business Manager) en Meta](configuracion-en-meta/como-verificar-tu-negocio-business-manager-en-meta.md)
* [Cómo verificar tu portafolio comercial de Meta](configuracion-en-meta/como-verificar-tu-portafolio-comercial-de-meta.md)
* [Cómo identificar y resolver una cuenta de WhatsApp restringida](configuracion-en-meta/como-identificar-y-resolver-una-cuenta-de-whatsapp-restringida.md)

## Conexión de Canales de Vambe
...
* [Guía de Conexión: WhatsApp API (Método QR)](conexion-de-canales-de-vambe/guia-de-conexion-whatsapp-api-metodo-qr.md)
...
* [Llamadas con IA (Vambe Phone)](vambe-llamados/llamadas-con-ia-vambe-phone.md)
