...
# Cómo ingresar a Vambe Ads

En este artículo aprenderás cómo acceder a **Vambe Ads** y crear tu primer **Workspace**, paso necesario para comenzar a gestionar campañas publicitarias desde Vambe.
...
* En el menú desplegable, selecciona **Vambe Ads**.

![Acceder a Vambe Ads](<.gitbook/assets/image png Dec 29 2025 01 24 13 4136 PM.png>)
{% endstep %}
...
✅ Listo. Ya tienes acceso a **Vambe Ads** y tu Workspace creado correctamente.

Ahora tienes que conectar tus canales para comenzar las configuraciones.
{% endstep %}
{% endstepper %}
